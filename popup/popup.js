...
window.addEventListener("DOMContentLoaded", function () {
    ...
    console.log(logout);
    function loginFunc() {
        var identifier = document.getElementById("user").value;
    ...
    function logError(error) {
        console.error("Error occured: ".concat(error));
    }
    function connected(p) {
        ...
        portFromCS.onMessage.addListener(function (m) {
            portFromCS.postMessage({
                greeting: "In background script, received message from content script: ".concat(m.greeting),
            });
        });
    }
